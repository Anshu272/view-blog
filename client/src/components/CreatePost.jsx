  ...
  return (
    ...
    <form className='flex flex-col gap-4' >
      ...
      <div className='flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3'>
        ...
        <Button
          type='button'
          className='mx-3 rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-extrabold'
        >
            Upload image
        </Button>
      </div>
